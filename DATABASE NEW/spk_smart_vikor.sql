...
--
-- Host: 127.0.0.1
-- Generation Time: 25 Jul 2022 pada 10.57
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
CREATE TABLE IF NOT EXISTS `hasil_vikor` (
...
INSERT INTO `hasil_vikor` (`id_hasil_vikor`, `id_alternatif`, `nilai`) VALUES
(1, 11, 0.2355),
(2, 12, 0.2943),
(3, 13, 0.2693),
(4, 14, 0),
...
--
ALTER TABLE `hasil_smart`
  MODIFY `id_hasil_smart` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `hasil_vikor`
--
ALTER TABLE `hasil_vikor`
  MODIFY `id_hasil_vikor` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
